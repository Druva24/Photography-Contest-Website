 ...
 * @author manish
 */
public class voteviewer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet voteviewer</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet voteviewer at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       System.out.println("not a number"); 
            ...
            String email=(String)session.getAttribute("use");
...
//    totallist=(ArrayList<image>) session.getAttribute("totallist");
        ...
        try 
        {
            register=db.likeimageview(email,imagelist.get(id));
           // 
