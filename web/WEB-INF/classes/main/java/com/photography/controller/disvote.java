 ...
 * @author manish
 */
public class disvote extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet disvote</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet disvote at "  + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//    totallist=(ArrayList<image>) session.getAttribute("totallist");
   // processRequest(request, response);
    //if(!likelist.isEmpty()){
        ...
        try 
        {
            register=db.dislikeimage(name,imagelist.get(id));
           // 
