...
-->
	...
	<body>
            ...
            <h1 style="text-align:center;color:#009999 ;">Contest Manager Login</h1>
...
%>                  
	<section class = "login-form">
		<div class ="form-box">
			<form method ="post" id="login" class="input-group" action="../conlogin" onsubmit= "return validation();" >
				<div >
