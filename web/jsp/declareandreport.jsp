        ...
        <hr class="w3-clear">
          <div class="w3-row-padding" style="margin:0 -16px">
            <div class="w3-half">
              ...
              <h4  class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-thumbs-up" onclick="document.location.href='../jsp/winner.jsp?id=${j.name}'"></i>  Declare as winner</h4>  
              <h4  class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-thumbs-down" onclick="document.location.href='../jsp/report.jsp?id=${j.name}'"></i>  Report Account</h4> 
      </div>
          </c:forEach>  
    <% }
    else
