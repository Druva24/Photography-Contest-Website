    ...
    <h2> <c:out value="${j.like}" /> </h2>
          ...
          <div class="w3-row-padding" style="margin:0 -16px">
            <div class="w3-half">
              ...
              <h4  class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-thumbs-up" onclick="document.location.href='http://localhost:8080/java1/voteviewer?id=<%=i%>'"></i>  Like</h4>  
              <h4  class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-thumbs-down" onclick="document.location.href='http://localhost:8080/java1/disvoteviewer?id=<%=i%>'"></i>  DisLike</h4> 
              <hr class="w3-clear">
      </div>
    <%
        i++;
