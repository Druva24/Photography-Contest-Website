...
String sql ="select * from REPORTEDACCOUNTS ";
...
<td><a href="deleteprocess.jsp?id=<%=resultSet.getString("username") %>"><button type="button"  class="delete">Delete</button></a></td>
</tr>
<%
i++;
}
if(flag==1){%><h2>  No Account is Reported</h2><%}
connection.close();
} catch (Exception e) {
e.printStackTrace();
}
